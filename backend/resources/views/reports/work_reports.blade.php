    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="color: white; background-color: #1e3a8a;">Deskripsi Pekerjaan</th>
                <th style="color: white; background-color: #1e3a8a;">Catatan</th>
                <th style="color: white; background-color: #1e3a8a;">Kendala</th>
            </tr>
        </thead>
        <tbody>
