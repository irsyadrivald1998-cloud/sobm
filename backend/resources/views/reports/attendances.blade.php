...
<head>
    ...
    <style>
        ...
        .badge-cuti { background-color: #e0e7ff; color: #3730a3; }
    </style>
</head>
<body>
    <div class="header">
    ...
    <div class="report-info">
        ...
        <div><strong>Total Data:</strong> {{ $attendances->count() }} Absensi</div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="color: white; background-color: #1e3a8a;">Clock In</th>
                <th style="color: white; background-color: #1e3a8a;">Clock Out</th>
                <th style="color: white; background-color: #1e3a8a;">Status</th>
                <th style="color: white; background-color: #1e3a8a;">Lokasi Clock In</th>
                <th style="color: white; background-color: #1e3a8a;">Lokasi Clock Out</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $attendance->user ? ucfirst($attendance->user->role) : '-' }}</td>
                ...
                <td>{{ $attendance->clock_in_latitude ? number_format($attendance->clock_in_latitude, 6) . ', ' . number_format($attendance->clock_in_longitude, 6) : '-' }}</td>
                <td>{{ $attendance->clock_out_latitude ? number_format($attendance->clock_out_latitude, 6) . ', ' . number_format($attendance->clock_out_longitude, 6) : '-' }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
